...
<div class="modal fade" tabindex="-1" id="kt_modal_1">
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title" id="modal_title">Create Costcenter</h5>
				<!--begin::Close-->
				<div class="btn btn-icon btn-sm btn-active-light-primary ms-2" data-bs-dismiss="modal" aria-label="Close">
					<span class="svg-icon fs-2x"></span>
				</div>
			...
			<div class="modal-body" id="modal_body">
				<form class="form w-100" novalidate="novalidate" method="POST" action="<?php echo prefix_url; ?>app/setting/addCompany">
					...
					<div class="d-flex flex-column mb-8">
						<label class="fs-6 fw-semibold mb-2">Kode Costcenter</label>
						<input type="text" class="form-control form-control-solid" name="cost_code" autocomplete="off" required />
					</div>
					<div class="d-flex flex-column mb-8">
						<label class="fs-6 fw-semibold mb-2">Label Costcenter</label>
						<input type="text" class="form-control form-control-solid" name="cost_label" autocomplete="off" required />
					</div>
					<div class="d-flex flex-column mb-8">
						<label class="fs-6 fw-semibold mb-2">Company Costcenter</label>
						<input type="text" class="form-control form-control-solid" name="cost_company" autocomplete="off" required />
					</div>
